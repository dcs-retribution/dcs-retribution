...
class Faction:
    ...
    def apply_mod_settings(self, mod_settings: Optional[ModSettings] = None) -> None:
        ...
        if not mod_settings.vietnamwarvessels:
            ...
            self.remove_ship("P4")
            self.remove_ship("ATCH")
            self.remove_ship("ATCH_Heavy")
            self.remove_ship("CCB")
            self.remove_ship("USS_New_Jersey")
            self.remove_ship("USS_Oklahoma_City")
            self.remove_ship("USS_Bon_Homme_Richard")
            self.remove_ship("Essex_SCB125")
            self.remove_ship("USS_Enterprise_1966")
            self.remove_ship("USS_Enterprise_1969")
            self.remove_ship("USS_Mullany")
            self.remove_ship("USS_Forrest_Sherman")
            self.remove_ship("USS_Bigelow")
            self.remove_ship("USS_Knox")
            self.remove_ship("USS_Gray")
            self.remove_ship("USS_Kirk")
            self.remove_ship("IX514_Unarmed")
            self.remove_ship("IX514")
            self.remove_aircraft("vwv_a1_skyraider")
            self.remove_aircraft("vwv_ad4_skyraider")
            ...
            self.remove_aircraft("vwv_ec_121")
            self.remove_aircraft("vwv_l_1049")
            self.remove_aircraft("vwv_rf101b")
            self.remove_aircraft("sh2f")
            self.remove_aircraft("HH-2D Seasprite")
            self.remove_aircraft("vwv_ch46d")
            self.remove_aircraft("vwv_ch46d_late")

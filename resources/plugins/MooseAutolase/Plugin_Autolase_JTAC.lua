env.info("DCSRetribution|MOOSE Autolase plugin - configuration")
...
if dcsRetribution then
    if dcsRetribution.plugins then
        ...
        if dcsRetribution.plugins.MooseAutolase then
            JtacAlphaSmoke = dcsRetribution.plugins.MooseAutolase.JtacAlphaSmoke
            JtacAlphaUHF = dcsRetribution.plugins.MooseAutolase.JtacAlphaUHF
            JtacAlphaVHF = dcsRetribution.plugins.MooseAutolase.JtacAlphaVHF
            JtacAlphaRadiusNM = dcsRetribution.plugins.MooseAutolase.JtacAlphaRadiusNM
            JtacBravoSmoke = dcsRetribution.plugins.MooseAutolase.JtacBravoSmoke
            JtacBravoUHF = dcsRetribution.plugins.MooseAutolase.JtacBravoUHF
            JtacBravoVHF = dcsRetribution.plugins.MooseAutolase.JtacBravoVHF
            JtacBravoRadiusNM = dcsRetribution.plugins.MooseAutolase.JtacBravoRadiusNM
        else
...
if GROUP:FindByName("JTAC Alpha") then
    ...
    local Alpha_RetributionAutolase = AUTOLASE:New(Alpha_AutolaseSet, coalition.side.BLUE, JtacAlphaName .. " Autolase",
        ...
        :SetLasingParameters(15000, 60 * 5)
    ...
    function Alpha_RetributionAutolase:OnAfterLasing(From, Event, To, LaserSpot)
        ...
        if LaserSpot.coordinate == nil then
            ...
            local NewOrbitInPlace = AUFTRAG:NewORBIT_CIRCLE(TgtCoord, 18000, 120)
            ...
            local NewOrbitOverTarget = AUFTRAG:NewORBIT_CIRCLE(TgtCoord, 14000, 120)

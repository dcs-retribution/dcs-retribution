...
* **[Mission Planning]** Flights now route around the active ground battle instead of loitering over it: the front line is added to the navmesh as a soft cost penalty, so transiting flights cross it quickly at the least-exposed point. CAS/BAI targeting the front are unaffected.

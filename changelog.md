...
* **[Mission Generation]** Front-line ground groups are spread back along the line instead of stacking on a single tile: the generator keeps each group's lateral position and steps perpendicular from the front to find valid ground.

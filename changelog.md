...
* **[UI]** Edit a flight's waypoint altitudes faster: an "Apply to all" button sets every en-route waypoint to one MSL altitude, and the per-waypoint altitude editor now steps by 1000 ft.

...
* **[UI]** Planning dialogs surface more context at a glance: a one-line package summary (task, flight/player-slot counts, timing, departures) in the package window, live task/aircraft/squadron explanatory text and squadron tooltips in the flight creator, and a Mission Impact panel (bases captured/lost, runway damage, per-side losses) in the debrief.

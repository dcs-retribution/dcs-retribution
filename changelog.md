...
* **[Map]** Carrier/LHA control points show their ship group like other naval groups: the tooltip lists the carrier and escorts (with [DEAD] markers), the surviving escorts' air-defense rings are drawn, and the status marker stays yellow while any ship survives (red only once the whole group is gone).

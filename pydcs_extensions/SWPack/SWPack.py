...
class SWWeapons:
    ...
    PROTONF = {"clsid": "{PROTONF}", "name": "PROTONF", "weight": 50}
    PROTONM = {"clsid": "{PROTONM}", "name": "PROTONM", "weight": 50}
    PROTONM1 = {"clsid": "{PROTONM1}", "name": "PROTONM1", "weight": 50}
    PROTONM2 = {"clsid": "{PROTONM2}", "name": "PROTONM2", "weight": 50}
    PROTONM3 = {"clsid": "{PROTONM3}", "name": "PROTONM3", "weight": 0.1}
    PROTONMissile = {"clsid": "{PROTONMissile}", "name": "PROTONMissile", "weight": 50}
    ENERGY_CELL = {"clsid": "{AFUEL}", "name": "ENERGY CELL", "weight": 1005}
    ENERGY_CELL_ = {"clsid": "{TIEFUEL}", "name": "ENERGY CELL", "weight": 1005}
    ENERGY_CELL__ = {"clsid": "{HUNTFUEL}", "name": "ENERGY CELL", "weight": 1005}
    ENERGY_CELL___ = {"clsid": "{TIRFUEL}", "name": "ENERGY CELL", "weight": 1005}
    ENERGY_CELL____ = {"clsid": "{XFUELTANK}", "name": "ENERGY CELL", "weight": 2005}
...
class XWING(PlaneType):
    ...
    class Pylon1:
        PROTONM = (1, Weapons.PROTONM)

    class Pylon2:
        PROTONM = (2, Weapons.PROTONM)
        ENERGY_CELL____ = (2, Weapons.ENERGY_CELL____)

    class Pylon3:
        PROTONM = (3, Weapons.PROTONM)

    class Pylon4:
        PROTONM = (4, Weapons.PROTONM)

    class Pylon5:
        PROTONM = (5, Weapons.PROTONM)

    class Pylon6:
        PROTONM = (6, Weapons.PROTONM)

    class Pylon10:
        ENERGY_CELL____ = (10, Weapons.ENERGY_CELL____)
...
class YWING(PlaneType):
    ...
    class Pylon5:
        PROTONB = (5, Weapons.PROTONB)

    class Pylon6:
        PROTONB = (6, Weapons.PROTONB)
...
class AWING(PlaneType):
    ...
    class Pylon2:
        ENERGY_CELL = (2, Weapons.ENERGY_CELL)

    class Pylon3:
        PROTONM1 = (3, Weapons.PROTONM1)

    class Pylon10:
        ENERGY_CELL = (10, Weapons.ENERGY_CELL)
...
class TIE(PlaneType):
    ...
    class Pylon2:
        ENERGY_CELL_ = (2, Weapons.ENERGY_CELL_)

    class Pylon10:
        ENERGY_CELL_ = (10, Weapons.ENERGY_CELL_)
...
class HUNTER(PlaneType):
    ...
    class Pylon1:
        PROTONM2 = (1, Weapons.PROTONM2)

    class Pylon2:
        ENERGY_CELL__ = (2, Weapons.ENERGY_CELL__)

    class Pylon3:
        PROTONM2 = (3, Weapons.PROTONM2)

    class Pylon10:
        ENERGY_CELL__ = (10, Weapons.ENERGY_CELL__)
...
class tie_bomber_2(PlaneType):
    ...
    class Pylon1:
        PROTONM1 = (1, Weapons.PROTONM1)
        TER_9A_with_3_x_Mk_82___500lb_GP_Bomb_LD = (1, Weapons.TER_9A_with_3_x_Mk_82___500lb_GP_Bomb_LD)
        Mk_84___2000lb_GP_Bomb_LD = (1, Weapons.Mk_84___2000lb_GP_Bomb_LD)

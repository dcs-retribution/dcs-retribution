...
class F_16D_52(PlaneType):
    ...
    livery_name = "F_16D_52"  # from type
...
class F_16D_50(PlaneType):
    ...
    livery_name = "F_16D_50"  # from type
    Liveries = Liveries()[livery_name]
...
class F_16D_50_NS(PlaneType):
    ...
    livery_name = "F_16D_50_NS"  # from type
    Liveries = Liveries()[livery_name]
...
class F_16D_52_NS(PlaneType):
    ...
    livery_name = "F_16D_52_NS"  # from type
    Liveries = Liveries()[livery_name]
